...
Outputs:
- `src/assets/brand/png/fixfox_*.png` (16/24/32/48/64/128/256/512)
- `src/assets/brand/fixfox_icon.ico` (multi-layer)
- runtime assets remain canonical in `src/assets/brand/`
