...
class HistoryPage(PageScroll):
    ...
    def _build_ui(self) -> None:
        ...
        w.hist_status = QComboBox()
        w.hist_status.addItems(["All Statuses", "Success", "Completed With Issues", "Failed"])
        w.hist_status.currentTextChanged.connect(w._refresh_history)
        w.hist_playbook = QComboBox()
        w.hist_playbook.addItem("All Playbooks")
        w.hist_playbook.currentTextChanged.connect(w._refresh_history)
        w.hist_family = QComboBox()
        w.hist_family.addItem("All Families")
        w.hist_family.currentTextChanged.connect(w._refresh_history)
        ...
        center_layout.addWidget(w.hist_status)
        center_layout.addWidget(w.hist_playbook)
        center_layout.addWidget(w.hist_family)
        ...
        w.hist_run_detail = DrawerCard("Run Details")
        right_layout.addWidget(w.hist_run_detail)
