...
class SettingsPage(PageScroll):
    ...
    def _build_ui(self) -> None:
        ...
        c_priv.body_layout().addWidget(QLabel("What FixFox stores locally"))
        ...
        c_look.body_layout().addWidget(w._setting_hint("Pick from three real palettes: FixFox, Graphite, and High Contrast."))
        ...
        b_support = SoftButton("Open Support Bundle")
        b_support.clicked.connect(lambda: w.nav.setCurrentRow(w.NAV_ITEMS.index("Reports")))
