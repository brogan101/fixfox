...
class SettingsPage(PageScroll):
    ...
    def _build_ui(self) -> None:
        ...
        b_diag = SoftButton("Diagnostics")
        b_help = SoftButton("Support")
        b_reset.clicked.connect(w._reset_settings_defaults)
        w.s_export_btn.clicked.connect(w._export_settings_json)
        b_diag.clicked.connect(lambda: w._open_settings_section("Diagnostics"))
        ...
        tools_row_bottom.addWidget(b_diag, 0)
