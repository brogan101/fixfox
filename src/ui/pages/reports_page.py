...
class ReportsPage(PageScroll):
    ...
    def _build_ui(self) -> None:
        ...
        w.rep_session_summary = Card("Active Session", "Open a session from History or start a fresh diagnostic run.", right_widget=open_history_summary)
        ...
        w.rep_playbook_summary = Card("Script-backed Playbook Runs", "Run a diagnostic or playbook to capture findings, evidence, and validation notes.", right_widget=open_diagnose_summary)
        ...
        overview_row_layout.addWidget(w.rep_playbook_summary)
        ...
        w.rep_status = Card("Step 4: Create and Validate", "Generate a support bundle after evidence, masking, and validation are ready.")
